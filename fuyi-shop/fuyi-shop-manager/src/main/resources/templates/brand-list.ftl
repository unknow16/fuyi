<table class="easyui-datagrid" title="品牌列表"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/spu/brand/list',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
        <tr>
            <th data-options="field:'ck',checkbox:true"></th>
            <th data-options="field:'brandId',width:60">品牌ID</th>
            ...
            <th data-options="field:'webSite',width:70">website</th>
