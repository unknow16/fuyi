...
<head>
    ...
    <title>注册-个人用户</title>
    <link rel="stylesheet" type="text/css" href="/sso/css/headerfooter.css" />
	<link rel="stylesheet" type="text/css" href="/sso/css/jquery.alerts.css" />
	<link rel="stylesheet" type="text/css" href="/sso/css/headerfooterindex.css" />
	<script type="text/javascript" src="/sso/js/jquery-1.5.1.min.js"></script>
	<script type="text/javascript" src="/sso/js/jquery.cookie.js"></script>
	<script type="text/javascript" src="/sso/js/passport.common.js?v20140531"></script>
	<script type="text/javascript" src="/sso/js/jquery.alerts.js"></script>
	<script type="text/javascript" src="/sso/js/png.js?v20140521"></script>
</head>
<body>
	<!-- header -->
	<div class="header">
		<a href="http://www.e3mall.cn"><img src="/sso/images/logo.png" border="0" /><span>欢迎注册</span></a>
	</div>

	<!--mainStart-->
	<link rel="stylesheet" type="text/css" href="/sso/css/reg.css?v20140432" />
	<script type="text/javascript" src="/sso/js/allMail.js?v20140430"></script>
	<script type="text/javascript" src="/sso/js/reg.js?v20150122"></script>
	...
	<div class="tabBox clear">
		...
		<div class="login">已有账号，立即 <a href="http://localhost:8092/toLogin">登录</a></div>
	</div>
