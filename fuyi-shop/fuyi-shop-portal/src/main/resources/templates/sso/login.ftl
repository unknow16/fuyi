...
<head>
	...
	<script type="text/javascript" src="/sso/js/png.js"></script>
	<script type="text/javascript" src="/sso/js/cas.login.js"></script>
	<script type="text/javascript" src="/sso/js/capsLock.js"></script>
</head>
<body>
	<!-- header -->
	<div class="header">
		<a href="http://www.e3mall.cn"><img src="/sso/images/logo.png" border="0"><span>欢迎登录</span></a>
	</div>

	<!-- login_main -->
	<div class="login_main clear">
		<div class="pic">
			<a href="http://www.e3mall.cn/html/activity/1472720729.html" target="_blank"><img src="/sso/images/06f42c372620f92b40da77a8b23cdf7f.png"></a>
		</div>
		...
		<div class="login">
			<div class="login_header">
				<span>您还未登录</span>
				<a href="http://localhost:8092/toRegister">免费注册</a>
    		</div>
