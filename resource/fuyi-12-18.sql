...
-- ----------------------------
INSERT INTO `test_user` VALUES ('131', 'b', '2');
INSERT INTO `test_user` VALUES ('132', 'c', '3');
INSERT INTO `test_user` VALUES ('133', 'd', '4');
INSERT INTO `test_user` VALUES ('135', 'aaa', '123');
INSERT INTO `test_user` VALUES ('136', 'aaa', '123');
INSERT INTO `test_user` VALUES ('137', 'a', '1');
INSERT INTO `test_user` VALUES ('138', 'b', '2');
INSERT INTO `test_user` VALUES ('139', 'c', '3');
INSERT INTO `test_user` VALUES ('140', 'd', '4');
INSERT INTO `test_user` VALUES ('141', 'e', '5');
INSERT INTO `test_user` VALUES ('142', 'aaa', '123');
INSERT INTO `test_user` VALUES ('143', 'aaa', '123');
INSERT INTO `test_user` VALUES ('144', 'fuyi', '123');
INSERT INTO `test_user` VALUES ('145', 'bbb', '444');
INSERT INTO `test_user` VALUES ('146', 'aaa', '1234');
...
CREATE TABLE `ucenter_user` (
  ...
  `last_login_time` timestamp NOT NULL DEFAULT '1970-01-01 08:00:01' COMMENT '最后登录时间',
...
CREATE TABLE `upms_log` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `log_id` (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='操作日志';

-- ----------------------------
-- Records of upms_log
-- ----------------------------
INSERT INTO `upms_log` VALUES ('1', '登录', '', '1543138547629', '15', 'http://upms.zhangshuzheng.cn:1111', '/sso/login', 'http://upms.zhangshuzheng.cn:1111/sso/login', 'GET', null, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.67 Safari/537.36', '127.0.0.1', '\"/sso/login.jsp\"', null);
INSERT INTO `upms_log` VALUES ('2', '登录', '', '1543138563814', '97', 'http://upms.zhangshuzheng.cn:1111', '/sso/login', 'http://upms.zhangshuzheng.cn:1111/sso/login', 'POST', '{password=[123456],rememberMe=[false],backurl=[],username=[admin]}', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.67 Safari/537.36', '127.0.0.1', '{\"code\":10104,\"data\":\"密码错误！\",\"message\":\"Password error\"}', null);
INSERT INTO `upms_log` VALUES ('3', '登录', '', '1543138569958', '24', 'http://upms.zhangshuzheng.cn:1111', '/sso/login', 'http://upms.zhangshuzheng.cn:1111/sso/login', 'POST', '{password=[test],rememberMe=[false],backurl=[],username=[admin]}', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.67 Safari/537.36', '127.0.0.1', '{\"code\":10104,\"data\":\"密码错误！\",\"message\":\"Password error\"}', null);
INSERT INTO `upms_log` VALUES ('4', '登录', '', '1543138617173', '0', 'http://upms.zhangshuzheng.cn:1111', '/sso/login', 'http://upms.zhangshuzheng.cn:1111/sso/login', 'GET', null, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.67 Safari/537.36', '127.0.0.1', '\"/sso/login.jsp\"', null);
INSERT INTO `upms_log` VALUES ('5', '登录', 'admin', '1543138618511', '79', 'http://upms.zhangshuzheng.cn:1111', '/sso/login', 'http://upms.zhangshuzheng.cn:1111/sso/login', 'POST', '{password=[123456],rememberMe=[false],backurl=[],username=[admin]}', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.67 Safari/537.36', '127.0.0.1', '{\"code\":1,\"data\":\"http://upms.zhangshuzheng.cn:1111\",\"message\":\"success\"}', null);
INSERT INTO `upms_log` VALUES ('6', '后台首页', 'admin', '1543138618798', '96', 'http://upms.zhangshuzheng.cn:1111', '/manage/index', 'http://upms.zhangshuzheng.cn:1111/manage/index', 'GET', null, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.67 Safari/537.36', '127.0.0.1', '\"/manage/index.jsp\"', null);
...
-- ----------------------------
INSERT INTO `upms_permission` VALUES ('1', '1', '0', '系统组织管理', '1', 'Home', '/manage', 'fa fa-user-circle-o', '1', '1', '1');
INSERT INTO `upms_permission` VALUES ('2', '1', '1', '系统管理', '2', 'System', '/manage/system', '', '1', '2', '2');
INSERT INTO `upms_permission` VALUES ('3', '1', '1', '组织管理', '2', 'Organization', '/manage/organization', '', '1', '3', '3');
INSERT INTO `upms_permission` VALUES ('4', '1', '0', '角色用户管理', '1', 'Home', '/manage', 'fa fa-camera-retro', '1', '4', '4');
INSERT INTO `upms_permission` VALUES ('5', '1', '4', '角色管理', '2', 'Role', '/manage/role', 'fa fa-camera-retro', '1', '6', '6');
INSERT INTO `upms_permission` VALUES ('6', '1', '4', '用户管理', '2', 'User', '/manage/user', '', '1', '5', '5');
INSERT INTO `upms_permission` VALUES ('7', '1', '0', '权限资源管理', '1', 'Home', '/manage', 'fa fa-camera-retro', '1', '7', '7');
...
INSERT INTO `upms_permission` VALUES ('17', '2', '0', '标签类目管理', '1', null, '/', 'zmdi zmdi-menu', '1', '17', '17');
...
INSERT INTO `upms_permission` VALUES ('20', '2', '0', '文章评论管理', '1', null, '/', 'zmdi zmdi-collection-text', '1', '20', '20');
...
INSERT INTO `upms_permission` VALUES ('39', '1', '7', '权限管理', '2', 'Permission', '/manage/permission', null, '1', '39', '39');
...
-- ----------------------------
INSERT INTO `upms_role` VALUES ('1', 'ROLE_super', '超级管理员', '拥有所有权限', '1', '1');
INSERT INTO `upms_role` VALUES ('2', 'ROLE_admin', '管理员', '拥有除权限管理系统外的所有权限', '1487471013117', '1487471013117');
INSERT INTO `upms_role` VALUES ('3', 'ROLE_fuyi', 'fuyi', 'fuyi', '1', '1');
...
) ENGINE=InnoDB AUTO_INCREMENT=188 DEFAULT CHARSET=utf8mb4 COMMENT='角色权限关联表';
...
INSERT INTO `upms_role_permission` VALUES ('127', '3', '1');
INSERT INTO `upms_role_permission` VALUES ('128', '3', '2');
INSERT INTO `upms_role_permission` VALUES ('129', '3', '3');
INSERT INTO `upms_role_permission` VALUES ('130', '3', '24');
INSERT INTO `upms_role_permission` VALUES ('131', '3', '25');
INSERT INTO `upms_role_permission` VALUES ('132', '3', '26');
INSERT INTO `upms_role_permission` VALUES ('133', '3', '4');
INSERT INTO `upms_role_permission` VALUES ('134', '3', '5');
INSERT INTO `upms_role_permission` VALUES ('135', '3', '6');
INSERT INTO `upms_role_permission` VALUES ('136', '3', '7');
INSERT INTO `upms_role_permission` VALUES ('137', '3', '39');
INSERT INTO `upms_role_permission` VALUES ('138', '3', '36');
INSERT INTO `upms_role_permission` VALUES ('139', '3', '37');
INSERT INTO `upms_role_permission` VALUES ('140', '3', '38');
INSERT INTO `upms_role_permission` VALUES ('187', '2', '24');
...
-- ----------------------------
INSERT INTO `upms_system` VALUES ('1', 'fa fa-camera-retro', '/resources/zheng-admin/images/zheng-upms.png', '#29A176', 'http://upms.zhangshuzheng.cn:1111', '1', 'zheng-upms-server', '权限管理系统', '用户权限管理系统（RBAC细粒度用户权限、统一后台、单点登录、会话管理）', '1', '1');
INSERT INTO `upms_system` VALUES ('2', 'fa fa-camera-retro', '/resources/zheng-admin/images/zheng-cms.png', '#455EC5', 'http://cms.zhangshuzheng.cn:2222', '1', 'zheng-cms-admin', '内容管理系统', '内容管理系统（门户、博客、论坛、问答等）', '2', '2');
INSERT INTO `upms_system` VALUES ('3', 'fa fa-user-circle-o', '/resources/zheng-admin/images/zheng-pay.png', '#F06292', 'http://pay.zhangshuzheng.cn:3331', '1', 'zheng-pay-admin', '支付管理系统', '支付管理系统', '3', '3');
INSERT INTO `upms_system` VALUES ('4', 'fa fa-user-circle-o', '/resources/zheng-admin/images/zheng-ucenter.png', '#6539B4', 'http://ucenter.zhangshuzheng.cn:4441', '1', 'zheng-ucenter-home', '用户管理系统', '用户管理系统', '4', '4');
INSERT INTO `upms_system` VALUES ('5', 'fa fa-camera-retro', '/resources/zheng-admin/images/zheng-oss.png', '#0B8DE5', 'http://oss.zhangshuzheng.cn:7771', '1', 'zheng-oss-web', '存储管理系统', '存储管理系统', '5', '5');
...
-- ----------------------------
INSERT INTO `upms_user` VALUES ('1', 'admin', '$2a$10$WGzifViP.9h796gxWWNbGOydecagTE/6TWOT3zGEVfsKp9pVaQB.a', '66f1b370c660445a8657bf8bf1794486', '张恕征', '/resources/zheng-admin/images/avatar.jpg', '', '469741414@qq.com', '1', '0', '1');
...
INSERT INTO `upms_user` VALUES ('3', 'fuyi', '$2a$10$WGzifViP.9h796gxWWNbGOydecagTE/6TWOT3zGEVfsKp9pVaQB.a', null, '付一3', null, '17538142003', '469741414@qq.com', '1', '0', '1');
...
INSERT INTO `upms_user` VALUES ('7', 'fuyi7', 'fuyi', '', '付一7', '', '17538142003', '469741414@qq.com', '1', '0', '1');
INSERT INTO `upms_user` VALUES ('8', 'fuyi8', 'fuyi', '', '付一8', '', '17538142003', '469741414@qq.com', '1', '0', '1');
...
INSERT INTO `upms_user` VALUES ('21', 'aa', '$2a$10$diwW9C74oHej0dP2/tB.v.kRle8x/JvHB/B.10ZpjC2dCSiaW608G', null, null, null, null, null, '1', null, '1543151176151');
...
INSERT INTO `upms_user_role` VALUES ('9', '3', '3');
